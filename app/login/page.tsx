...
export default function Login() {
  return (
    <div className="px-6 py-12 lg:px-8 flex min-h-full flex-col justify-center">
      <div className="bg-white px-6 py-6 rounded-2xl mx-auto">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <div className="mt-10 text-2xl/9 font-bold tracking-tight text-gray-900 text-center">
            Login to Account
          </div>
          <div className="mt-10 text-sm font-extralight tracking-tight text-gray-900 text-center">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="/dash" method="POST" className="space-y-6">
            ...
            <div>
              <button
                className="rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold shadow-sm text-white mb-10 flex w-full justify-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                type="submit"
              >
